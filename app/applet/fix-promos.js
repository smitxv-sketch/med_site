const fs = require('fs');
let content = fs.readFileSync('/app/applet/src/widgets/promotions-widget/ui/PromotionsWidgetVariants.tsx', 'utf-8');
...
fs.writeFileSync('/app/applet/src/widgets/promotions-widget/ui/PromotionsWidgetVariants.tsx', content);
