      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-14 flex flex-col md:flex-row items-center justify-between gap-8 border-b border-gray-100 pb-12">
          ...
          <div className="flex items-center justify-center md:justify-end gap-4 w-full md:w-auto">
            {/* VK */}
            <a href="#" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center w-14 h-14 bg-gray-50 hover:bg-[#0077FF] text-gray-700 hover:text-white rounded-full transition-all duration-theme group">
            ...
            {/* OK */}
            <a href="#" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center w-14 h-14 bg-gray-50 hover:bg-[#EE8208] text-gray-700 hover:text-white rounded-full transition-all duration-theme group">
              <svg className="w-7 h-7 transition-transform group-hover:scale-110" fill="currentColor" viewBox="0 0 24 24">
