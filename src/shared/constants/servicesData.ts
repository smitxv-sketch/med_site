...
export const SERVICES_DATA = [
  ...
  },
  {
    ...
    description: 'Приём специалистов, диагностика и лечение по 40+ направлениям.',
    items: [
  ...
  },
  {
    id: 'ambulance',
    title: 'Скорая помощь',
    description: 'Вызов на дом, амбулаторный приём, помощь при укусе клеща.',
    items: [
  ...
  },
  {
    ...
    description: 'Медицинские чек-апы, скрининги и профилактика.',
    items: [
