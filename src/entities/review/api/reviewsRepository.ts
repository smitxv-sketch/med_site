...
const MOCK_REVIEWS: Review[] = [
  ...
  },
  {
    ...
    date: '28 марта 2024',
    text: 'Были на приеме у педиатра Васильевой. Очень приятный врач, быстро нашла подход к ребенку. Назначения все по делу, никаких лишних лекарств.',
    rating: 5,
    platform: 'napopravku',
    doctorId: 'd4',
  ...
  },
  {
    ...
    text: 'Администраторы очень вежливые, всегда напомнят о приеме. Сама клиника светлая, удобное расположение. Была на УЗИ, врач всё подробно показал на экране.',
    rating: 4,
    platform: 'yandex',
    clinicOnly: true
  },
