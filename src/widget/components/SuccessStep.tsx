...
export function SuccessStep() {
  ...
  return (
    <div className="text-center py-16 space-y-6 max-w-md mx-auto px-4 sm:px-0">
      ...
      <div className="bg-white p-8 rounded-2xl border border-gray-100 shadow-[0_4px_20px_-4px_rgba(0,0,0,0.05)] mt-8 text-left space-y-4 relative overflow-hidden">
