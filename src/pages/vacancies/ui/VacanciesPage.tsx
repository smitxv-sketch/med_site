...
const VACANCIES = [
  {
    ...
    description: 'Приглашаем в команду опытного врача-педиатра. Ведение амбулаторного приема, профилактические осмотры, вакцинация.'
  },
  {
    id: 2,
    ...
    description: 'Забор венозной и капиллярной крови, постановка инъекций и капельниц, соблюдение сан-эпид режима.'
  },
  {
    id: 3,
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-gray-600 mb-6 max-w-2xl mx-auto">
            Мы всегда рады талантливым специалистам. Отправьте свое резюме, и мы свяжемся с вами, как только появится подходящая позиция.
          </p>
