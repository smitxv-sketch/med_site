    ...
    <div className="absolute inset-0 z-[120] bg-white flex flex-col animate-in slide-in-from-bottom-full duration-theme">
      ...
      <div className="flex-1 overflow-y-auto p-6 flex flex-col items-center -mt-8 relative z-10">
        ...
        <div className="w-full mt-auto flex flex-col gap-3">
          <button className="w-full py-4 bg-platform-whatsapp text-white rounded-2xl font-bold text-sm flex items-center justify-center gap-2 shadow-lg shadow-platform-whatsapp/30 active:scale-95 transition-transform">
