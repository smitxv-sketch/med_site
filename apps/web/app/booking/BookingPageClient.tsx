  ...
  return (
    ...
    >
      <SiteChrome hideBottomNav>
        {/* max-w-7xl — как Container в хедере и на остальных страницах */}
        <div className="booking-page mx-auto w-full max-w-7xl px-4 pb-safe pt-4 sm:px-6 lg:px-8 sm:pt-6">
